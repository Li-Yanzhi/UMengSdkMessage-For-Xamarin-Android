...
namespace Org.Android.Spdy {
	...
	public partial interface ISessionCb : IJavaObject {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.spdy']/interface[@name='SessionCb']/method[@name='spdyPingRecvCallback' and count(parameter)=4 and parameter[1][@type='org.android.spdy.SpdySession'] and parameter[2][@type='long'] and parameter[3][@type='java.lang.Object'] and parameter[4][@type='int']]"
		[Register ("spdyPingRecvCallback", "(Lorg/android/spdy/SpdySession;JLjava/lang/Object;I)V", "GetSpdyPingRecvCallback_Lorg_android_spdy_SpdySession_JLjava_lang_Object_IHandler:Org.Android.Spdy.ISessionCbInvoker, UMengSdkMessage")]
		...
		[Register ("spdySessionCloseCallback", "(Lorg/android/spdy/SpdySession;Ljava/lang/Object;Lorg/android/spdy/SuperviseConnectInfo;)V", "GetSpdySessionCloseCallback_Lorg_android_spdy_SpdySession_Ljava_lang_Object_Lorg_android_spdy_SuperviseConnectInfo_Handler:Org.Android.Spdy.ISessionCbInvoker, UMengSdkMessage")]

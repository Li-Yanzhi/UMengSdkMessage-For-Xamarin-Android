...
namespace Org.Android.Spdy {
	...
	public sealed partial class SpdyRequest : global::Java.Lang.Object {
		...
		static IntPtr id_ctor_Ljava_net_URL_Ljava_lang_String_ILjava_lang_String_Lorg_android_spdy_RequestPriority_ZIII;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.android.spdy']/class[@name='SpdyRequest']/constructor[@name='SpdyRequest' and count(parameter)=9 and parameter[1][@type='java.net.URL'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='org.android.spdy.RequestPriority'] and parameter[6][@type='boolean'] and parameter[7][@type='int'] and parameter[8][@type='int'] and parameter[9][@type='int']]"
		[Register (".ctor", "(Ljava/net/URL;Ljava/lang/String;ILjava/lang/String;Lorg/android/spdy/RequestPriority;ZIII)V", "")]
		public SpdyRequest (global::Java.Net.URL p0, string p1, int p2, string p3, global::Org.Android.Spdy.RequestPriority p4, bool p5, int p6, int p7, int p8) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			if (GetType () != typeof (SpdyRequest)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/net/URL;Ljava/lang/String;ILjava/lang/String;Lorg/android/spdy/RequestPriority;ZIII)V", new JValue (p0), new JValue (native_p1), new JValue (p2), new JValue (native_p3), new JValue (p4), new JValue (p5), new JValue (p6), new JValue (p7), new JValue (p8)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/net/URL;Ljava/lang/String;ILjava/lang/String;Lorg/android/spdy/RequestPriority;ZIII)V", new JValue (p0), new JValue (native_p1), new JValue (p2), new JValue (native_p3), new JValue (p4), new JValue (p5), new JValue (p6), new JValue (p7), new JValue (p8));
				JNIEnv.DeleteLocalRef (native_p1);
				JNIEnv.DeleteLocalRef (native_p3);
				return;
			}

			if (id_ctor_Ljava_net_URL_Ljava_lang_String_ILjava_lang_String_Lorg_android_spdy_RequestPriority_ZIII == IntPtr.Zero)
				id_ctor_Ljava_net_URL_Ljava_lang_String_ILjava_lang_String_Lorg_android_spdy_RequestPriority_ZIII = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/net/URL;Ljava/lang/String;ILjava/lang/String;Lorg/android/spdy/RequestPriority;ZIII)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_net_URL_Ljava_lang_String_ILjava_lang_String_Lorg_android_spdy_RequestPriority_ZIII, new JValue (p0), new JValue (native_p1), new JValue (p2), new JValue (native_p3), new JValue (p4), new JValue (p5), new JValue (p6), new JValue (p7), new JValue (p8)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_net_URL_Ljava_lang_String_ILjava_lang_String_Lorg_android_spdy_RequestPriority_ZIII, new JValue (p0), new JValue (native_p1), new JValue (p2), new JValue (native_p3), new JValue (p4), new JValue (p5), new JValue (p6), new JValue (p7), new JValue (p8));
			JNIEnv.DeleteLocalRef (native_p1);
			JNIEnv.DeleteLocalRef (native_p3);
		}
		...
		static IntPtr id_isQuic;
		public bool IsQuic {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.spdy']/class[@name='SpdyRequest']/method[@name='isQuic' and count(parameter)=0]"
			[Register ("isQuic", "()Z", "GetIsQuicHandler")]
			get {
				if (id_isQuic == IntPtr.Zero)
					id_isQuic = JNIEnv.GetMethodID (class_ref, "isQuic", "()Z");
				return JNIEnv.CallBooleanMethod  (Handle, id_isQuic);
			}
		}

...
#pragma warning restore 0169
		...
		// Metadata.xml XPath class reference: path="/api/package[@name='com.umeng.message']/class[@name='MsgLogStore.MsgLogStoreHelper']"
		[global::Android.Runtime.Register ("com/umeng/message/MsgLogStore$MsgLogStoreHelper", DoNotGenerateAcw=true)]
		public partial class MsgLogStoreHelper : global::Android.Database.Sqlite.SQLiteOpenHelper {

			internal static IntPtr java_class_handle;
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/umeng/message/MsgLogStore$MsgLogStoreHelper", ref java_class_handle);
				}
			}
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (MsgLogStoreHelper); }
			}

			protected MsgLogStoreHelper (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

			static IntPtr id_ctor_Lcom_umeng_message_MsgLogStore_Landroid_content_Context_;
			// Metadata.xml XPath constructor reference: path="/api/package[@name='com.umeng.message']/class[@name='MsgLogStore.MsgLogStoreHelper']/constructor[@name='MsgLogStore.MsgLogStoreHelper' and count(parameter)=2 and parameter[1][@type='com.umeng.message.MsgLogStore'] and parameter[2][@type='android.content.Context']]"
			[Register (".ctor", "(Lcom/umeng/message/MsgLogStore;Landroid/content/Context;)V", "")]
			public MsgLogStoreHelper (global::Com.Umeng.Message.MsgLogStore __self, global::Android.Content.Context p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (Handle != IntPtr.Zero)
					return;

				if (GetType () != typeof (MsgLogStoreHelper)) {
					SetHandle (
				...
				if (id_ctor_Lcom_umeng_message_MsgLogStore_Landroid_content_Context_ == IntPtr.Zero)
					id_ctor_Lcom_umeng_message_MsgLogStore_Landroid_content_Context_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/umeng/message/MsgLogStore;Landroid/content/Context;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_umeng_message_MsgLogStore_Landroid_content_Context_, new JValue (__self), new JValue (p1)),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_umeng_message_MsgLogStore_Landroid_content_Context_, new JValue (__self), new JValue (p1));
			}
...
#pragma warning disable 0169
			...
			{
				global::Com.Umeng.Message.MsgLogStore.MsgLogStoreHelper __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.MsgLogStore.MsgLogStoreHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='MsgLogStore.MsgLogStoreHelper']/method[@name='onCreate' and count(parameter)=1 and parameter[1][@type='android.database.sqlite.SQLiteDatabase']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='MsgLogStore.MsgLogStoreHelper']/method[@name='onUpgrade' and count(parameter)=3 and parameter[1][@type='android.database.sqlite.SQLiteDatabase'] and parameter[2][@type='int'] and parameter[3][@type='int']]"

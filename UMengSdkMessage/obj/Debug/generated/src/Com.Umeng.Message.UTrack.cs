...
#pragma warning restore 0169
		...
		static Delegate cb_trackMsgClick_Lcom_umeng_message_entity_UMessage_;
#pragma warning disable 0169
		static Delegate GetTrackMsgClick_Lcom_umeng_message_entity_UMessage_Handler ()
		{
			if (cb_trackMsgClick_Lcom_umeng_message_entity_UMessage_ == null)
				cb_trackMsgClick_Lcom_umeng_message_entity_UMessage_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_TrackMsgClick_Lcom_umeng_message_entity_UMessage_);
			return cb_trackMsgClick_Lcom_umeng_message_entity_UMessage_;
		}

		static void n_TrackMsgClick_Lcom_umeng_message_entity_UMessage_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Umeng.Message.UTrack __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.UTrack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			__this.TrackMsgClick (p0);
		}
#pragma warning restore 0169

		static IntPtr id_trackMsgClick_Lcom_umeng_message_entity_UMessage_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='UTrack']/method[@name='trackMsgClick' and count(parameter)=1 and parameter[1][@type='com.umeng.message.entity.UMessage']]"
		[Register ("trackMsgClick", "(Lcom/umeng/message/entity/UMessage;)V", "GetTrackMsgClick_Lcom_umeng_message_entity_UMessage_Handler")]
		public virtual void TrackMsgClick (global::Com.Umeng.Message.Entity.UMessage p0)
		{
			if (id_trackMsgClick_Lcom_umeng_message_entity_UMessage_ == IntPtr.Zero)
				id_trackMsgClick_Lcom_umeng_message_entity_UMessage_ = JNIEnv.GetMethodID (class_ref, "trackMsgClick", "(Lcom/umeng/message/entity/UMessage;)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_trackMsgClick_Lcom_umeng_message_entity_UMessage_, new JValue (p0));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "trackMsgClick", "(Lcom/umeng/message/entity/UMessage;)V"), new JValue (p0));
		}

		static Delegate cb_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_;
#pragma warning disable 0169
		static Delegate GetTrackMsgDismissed_Lcom_umeng_message_entity_UMessage_Handler ()
		{
			if (cb_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_ == null)
				cb_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_TrackMsgDismissed_Lcom_umeng_message_entity_UMessage_);
			return cb_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_;
		}

		static void n_TrackMsgDismissed_Lcom_umeng_message_entity_UMessage_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Umeng.Message.UTrack __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.UTrack> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Com.Umeng.Message.Entity.UMessage p0 = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.Entity.UMessage> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.TrackMsgDismissed (p0);
		}
#pragma warning restore 0169

		static IntPtr id_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='UTrack']/method[@name='trackMsgDismissed' and count(parameter)=1 and parameter[1][@type='com.umeng.message.entity.UMessage']]"
		[Register ("trackMsgDismissed", "(Lcom/umeng/message/entity/UMessage;)V", "GetTrackMsgDismissed_Lcom_umeng_message_entity_UMessage_Handler")]
		public virtual void TrackMsgDismissed (global::Com.Umeng.Message.Entity.UMessage p0)
		{
			if (id_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_ == IntPtr.Zero)
				id_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_ = JNIEnv.GetMethodID (class_ref, "trackMsgDismissed", "(Lcom/umeng/message/entity/UMessage;)V");

			if (GetType () == ThresholdType)
				JNIEnv.CallVoidMethod  (Handle, id_trackMsgDismissed_Lcom_umeng_message_entity_UMessage_, new JValue (p0));
			else
				JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "trackMsgDismissed", "(Lcom/umeng/message/entity/UMessage;)V"), new JValue (p0));
		}
